  ...
  return (
    ...
    <div className='relative h-screen overflow-x-hidden  ' >
      ...
      <div className="w-full max-w-lg p-6  rounded-lg">
        <h3 className=" text-2xl md:text-4xl font-semibold text-center">Verify your email</h3>
        ...
        <form className="mt-6 space-y-4">
          <div  >
            ...
            <input
              type="number"
              id="OTP"
              className="block h-12 w-full px-4 py-2 mt-1 text-white bg-black border border-[#313333]  rounded-md  "
