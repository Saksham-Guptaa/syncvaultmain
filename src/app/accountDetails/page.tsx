  ...
  return (
    ...
    <div className="relative h-screen overflow-x-hidden">
        ...
        <div className="flex relative items-center justify-center w-full md:w-[50%] mx-auto min-h-screen bg-black mr-[100%] text-white">
          <div className="w-full max-w-lg p-6 rounded-lg">
            ...
            >
              ...
              <button
                type="submit"
                className="w-full h-12 py-2 text-xs font-medium text-white bg-[#E9004C] rounded-md hover:bg-pink-600 focus:outline-none focus:ring focus:ring-pink-300"
              >
                Continue
              </button>
              ...
              >
                <img
                  src="/google.png" // Add Google logo
                  alt="Google"
      ...
      <div className="flex items-center space-x-4">
        {/* Avatar display */}
        <div className="w-12 h-12 bg-gray-500 text-black flex items-center justify-center rounded-md overflow-hidden">
          {avatar ? (
        ...
        <button
          type="button"
          className="text-xs px-4 py-2 bg-gray-800 text-white rounded-md hover:bg-gray-700 relative"
        >
      ...
      <button
        ...
        disabled={!avatar} // Disable button if no avatar is selected
      >
        Remove
      </button>
    </div>
